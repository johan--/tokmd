...
| Analysis DTO contracts | `crates/tokmd-analysis-types/src/lib.rs` and owner DTO modules | `lib.rs` 279; entropy owner tests 47; license owner tests 32 | Continue moving domain serde tests and DTO-family ownership into modules while keeping root receipt glue and re-exports stable |
