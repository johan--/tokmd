...
| Format core outputs | `crates/tokmd-format/src/diff.rs`, `crates/tokmd-format/src/diff/`, `crates/tokmd-format/src/export.rs`, `crates/tokmd-format/src/export/`, `crates/tokmd-format/src/summary.rs`, and `crates/tokmd-format/src/summary/` | `diff.rs` 574; diff compute owner 168; export 314; export CSV owner 55; export JSON owner 76; export JSONL owner 136; export CycloneDX owner 152; summary 557; language summary owner 95; module summary owner 58 | Diff row/total computation, CSV/JSON/JSONL/CycloneDX export rendering, and language/module summary table rendering now live in dedicated owner modules while public helpers and output behavior stay unchanged; future diff rendering or summary JSON/file-writing splits should be snapshot-backed and preserve the root `tokmd-format` re-exports |
