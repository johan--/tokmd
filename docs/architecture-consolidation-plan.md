...
| --- | --- | ---: | --- |
| Content complexity | `crates/tokmd-analysis/src/content/complexity.rs` and `crates/tokmd-analysis/src/content/complexity/` | `tests/unit.rs` 171; cyclomatic test owner 562; cognitive test owner 194; function test owner 404; production owner modules <=187 | Scoring, nesting, and function-span helpers now live under owner modules; function-detection, cyclomatic, and cognitive proof tests now have dedicated owners; remaining work is mostly nesting test split and aggregation cleanup |
