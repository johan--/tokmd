...
| Analysis DTO contracts | `crates/tokmd-analysis-types/src/lib.rs` and owner DTO modules | `lib.rs` 113; envelope owner 19; receipt owner 37; fun owner tests 39; topics owner tests 37; entropy owner tests 47; license owner tests 32; churn owner tests 38; complexity owner tests 263; effort owner tests 182 | Keep root receipt glue and public re-exports stable while moving remaining DTO ownership into modules |
