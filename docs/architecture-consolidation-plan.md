...
| Analysis DTO contracts | `crates/tokmd-analysis-types/src/lib.rs` and owner DTO modules | `lib.rs` 313; entropy owner tests 53 | Continue moving domain serde tests and DTO-family ownership into modules while keeping root receipt glue and re-exports stable |
