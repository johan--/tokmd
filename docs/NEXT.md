...
- Next proof-policy operational slice: wire the promotion criteria into the manual observation collector defaults or summary output, while keeping the executor non-required and Codecov upload manually gated.
